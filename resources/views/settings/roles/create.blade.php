...
<x-breadcrumb :items="[
    ...
    ['label' => 'Tambah Data Role', 'route' => route('roles.create')],
]" />
@endsection
                ...
                <div class="card my-4">
                    ...
                    <form action="{{ route('roles.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body px-4 pb-4">
                            <div class="mb-3">
                                <label for="address" class="form-label">Nama Role</label>
                                <input class="form-control border border-dark px-3" id="name" name="name"
                                    rows="1" placeholder="Masukkan Nama Role" required></input>
                                @error('name')
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control border border-dark px-3" id="code" name="code"
                                    rows="1" placeholder="Masukkan Kode Role" required></input>
                                @error('code')
                                    <div class="text-danger small">{{ $message }}</div>
                                @enderror
                            </div>
